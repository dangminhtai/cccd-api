...
class TestProvinceMapping(unittest.TestCase):
    ...
    def test_province_name_resolved(self):
        ...
        resp = self.client.post("/v1/cccd/parse", json={"cccd": "079203012345", "province_version": "legacy_63"})
    ...
    def test_province_code_not_found_warning(self):
        # 999 not in mapping
        resp = self.client.post("/v1/cccd/parse", json={"cccd": "999203012345", "province_version": "legacy_63"})
        self.assertEqual(resp.status_code, 200)
        body = resp.get_json()
